...
from OTAKU.utils.OTAKU_BAN import admin_filter
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("OTAKU/assets/OTAKUWLCM.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((500, 500))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('OTAKU/assets/font.ttf', size=60)
    welcome_font = ImageFont.truetype('OTAKU/assets/font.ttf', size=60)

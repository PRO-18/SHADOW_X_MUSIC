...
from OTAKU.mongo.notesdb import *
from OTAKU.utils.notes_func import GetNoteMessage, exceNoteMessageSender, privateNote_and_admin_checker
from OTAKU.utils.yumidb import user_admin

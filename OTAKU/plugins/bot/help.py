...
from OTAKU.utils import help_pannel
from OTAKU.utils.database import get_lang
from OTAKU.utils.decorators.language import LanguageStart, languageCB
from OTAKU.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from OTAKU.help.buttons import BUTTONS
from OTAKU.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_OTAKU, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
